...
- Naming: use **Jarvis** for product/app/docs headings; use `jarvis` for CLI command and user-facing names. Internal code may still use `openclaw` for backward compatibility.
